...
public class TC_HumanResourcesUser_001 extends BaseClass {

	@Test (priority=0)
	public void  humanResourcesUserLogin() throws InterruptedException, IOException 
	{
	...
	@Test (priority=1)
	public void  humanResourcesUserHeader() throws InterruptedException, IOException 
	{
		HumanResourcesUser hru= new HumanResourcesUser(driver);
		ParkAssociateUser pau= new ParkAssociateUser(driver);
		...
		boolean isPageHeader = hru.verifyHeaderHRUR();
		if(isPageHeader == true) 
		{
			logger.info("Human Resources User Header is displayed");
			captureScreen(driver, "HumanResourcesUser");
		}
		else
		{
			logger.info("Human Resources User Header is not displayed");
		}
	}
	...
	@Test (priority=7)
	public void  humanResourcesUserDetails1() throws InterruptedException, IOException 
	{
		HumanResourcesUser hru= new HumanResourcesUser(driver);
		ParkAssociateUser pau= new ParkAssociateUser(driver);
		...
		logger.info("Human Resources User Text is displayed");
	...
	@Test (priority=11)
	public void  humanResourcesUserDetails2() throws InterruptedException, IOException 
	{
		ParkAssociateUser pau= new ParkAssociateUser(driver);
	...
	@Test (priority=12)
	public void  humanResourcesTaskbox() throws InterruptedException, IOException 
	{
		ParkSupervisorUser psu= new ParkSupervisorUser(driver);
		ParkAssociateUser pau= new ParkAssociateUser(driver);
	...
	@Test (priority=15)
	public void  humanResourcesUserRequests() throws InterruptedException, IOException 
	{
		ParkAssociateUser pau= new ParkAssociateUser(driver);
	...
	@Test (priority=16)
	public void  humanResourcesForms() throws InterruptedException, IOException 
	{
		ParkAssociateUser pau= new ParkAssociateUser(driver);
	...
	public void  hrFormsSignIn() throws InterruptedException, IOException 
	{
		...
		logger.info("Human Resources User Icon is clicked");
